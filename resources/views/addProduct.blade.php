...
@section('content')
    <div class="container-fluid">
        <div class="row d-flex justify-content-center align-items-center min-vh-100">
            <div class="col-4">
                <form action="{{ route('product.create') }}" method="post" class="border rounded bg-secondary-subtle">
                    @csrf
                    <h2 class="m-2">Add Product</h2>
                    @if (session('status'))
                    ...
                    <div class="mb-3 mx-2">
                        ...
                        <input type="number" id="p_quantity" name="p_quantity" class="form-control">
